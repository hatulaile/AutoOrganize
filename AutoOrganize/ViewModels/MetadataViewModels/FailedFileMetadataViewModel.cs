...
public sealed partial class FailedFileMetadataViewModel : MetadataViewModelBase<FailedFile>
{
    ...
    protected override void MetadataChanging(FailedFile? value)
    {
    ...
    public FailedFileMetadataViewModel(ILauncherServices launcherServices, IClipboardServices clipboardServices)
    {

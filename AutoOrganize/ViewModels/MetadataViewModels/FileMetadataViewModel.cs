...
public sealed partial class FileMetadataViewModel : MetadataViewModelBase<FileModel>
{
    ...
    protected override void MetadataChanging(FileModel? value)
    {
    ...
    protected override void MetadataChanged(FileModel? value)
    {

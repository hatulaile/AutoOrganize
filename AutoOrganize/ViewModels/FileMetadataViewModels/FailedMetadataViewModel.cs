...
public sealed partial class FailedMetadataViewModel : MetadataViewModelBase<FailedFileMetadata>
{
    ...
    protected override void MetadataChanging(FailedFileMetadata? value)
    {
    ...
    protected override void MetadataChanged(FailedFileMetadata? value)
    {

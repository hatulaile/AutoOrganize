...
public sealed partial class TransferredFileViewModel : MetadataViewModelBase<TransferredFileNode>
{
    ...
    protected override void MetadataChanging(TransferredFileNode? value)
    {
    ...
    public TransferredFileViewModel(ILauncherServices launcherServices, IClipboardServices clipboardServices)
    {
